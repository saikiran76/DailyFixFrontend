// src/components/platforms/SlackChatList.jsx
import React from 'react';

function SlackChatList({ messages, onSelectRoom }) {
  ...
  return (
    <div className="p-4">
      <h2 className="text-lg font-semibold mb-4">Slack Channels</h2>
      <ul>
        {rooms.map(r => (
